...
@AutoGenerated
public class PersonBridge implements IEntityBridge {

	private static final String TableName = "person";

	private static Object _lock = new Object();
	private static PersonBridge _instance;
	
	private PersonBridge() {}

	public static PersonBridge getInstance() {
		if (_instance == null) {
			synchronized(_lock) {
				if (_instance == null) {
					_instance = new PersonBridge();
				}
			}
		}
		return _instance;
	...
	public void populateEntity(IEntity ientity, IGetValue<Integer, String, Object, Object> iterator) throws SQLException, InterruptedException {
		...
		entity.setEmail((String) iterator.get(3, "email", entity.getEmail()));
